...
export default (() => {
	return <Theme theme={theme}>
		...
		<Helmet>
			...
			<meta property={"og:title"} content={"Home | Enchanted Realms"} />
		...
		>
			...
			<Box
				...
				display="flex"
				justify-content="center"
				background="linear-gradient(180deg,rgba(155, 108, 252, 0.15) 0%,transparent 100%) 0 0 no-repeat,--color-darkL2 url(https://uploads.quarkly.io/663cf7db3f24780021f6cc6a/images/Screenshot%202024-05-11%20at%2013.29.42.png?v=2024-05-11T11:29:50.566Z) 0% 0%/cover"
				md-min-height="360px"
				sm-min-height="180px"
				width="100%"
				min-height="480px"
				height="240px"
				sm-background="--color-darkL2 url(https://uploads.quarkly.io/663cf7db3f24780021f6cc6a/images/Screenshot%202024-05-11%20at%2013.32.32.png?v=2024-05-11T11:32:44.997Z) 0% 0%/cover"
				flex="0 1 auto"
				align-self="auto"
			/>
		</Section>
